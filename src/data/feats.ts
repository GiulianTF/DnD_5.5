...
export const FEATS: Feat[] = [
  ...
  { id: 'mestre-em-armas-de-hasta', name: 'Mestre em Armas de Haste', category: 'geral', desc: '+1 FOR ou DES. Com lança, azagaia ou arma de haste: ataque Bônus com a outra extremidade (1d4); reação de ataque quando inimigos entram no seu alcance.', abilityIncrease: ['for', 'des'] },
