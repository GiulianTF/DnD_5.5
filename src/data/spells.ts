...
/**
 * Catálogo COMPLETO de magias do Livro do Jogador 2024 (PT-BR): 391 magias,
 * do truque ao 9º círculo, de todas as classes conjuradoras.
 *
 * ATENÇÃO: este arquivo é gerado a partir de `regras/livro-jogador.pdf` (capítulo 7).
 * O texto de cada magia é a descrição integral do livro, sem resumos — não edite à mão.
 */
export const SPELLS: Spell[] = [

  // ======================== Truques (Círculo 0) ========================
  {
    id: 'acudir-os-moribundos',
  ...
  },
  {
    ...
    level: 1,
    school: 'Abjuração',
    classes: ['bardo', 'clerigo', 'druida', 'patrulheiro', 'paladino'],
    castingTime: 'Ação',
    range: 'Toque',
    components: 'V, S',
    duration: 'Instantânea',
  ...
  },
  {
    ...
    school: 'Necromancia',
    classes: ['paladino'],
    castingTime: 'Ação Bônus, que você realiza imediatamente após atingir uma criatura com uma arma Corpo a Corpo ou um Ataque Desarmado',
    range: 'Pessoal',
    components: 'V',
    duration: '1 minuto',
    desc: [
  ...
  },
  {
    ...
    level: 1,
    school: 'Adivinhação',
    classes: ['bardo', 'bruxo', 'clerigo', 'druida', 'feiticeiro', 'patrulheiro', 'mago', 'paladino'],
    castingTime: 'Ação ou Ritual',
    range: 'Pessoal',
    components: 'V, S',
  ...
  },
  {
    ...
    level: 1,
    school: 'Adivinhação',
    classes: ['bardo', 'bruxo', 'druida', 'patrulheiro'],
    castingTime: 'Ação ou Ritual',
    range: 'Pessoal',
    components: 'V, S',
    duration: '10 minutos',
  ...
  {
    id: 'gargalhada-nefasta-de-tasha',
  ...
  },
  {
    ...
    level: 1,
    school: 'Abjuração',
    classes: ['bruxo', 'clerigo', 'druida', 'mago', 'paladino'],
    castingTime: 'Ação',
    range: 'Toque',
  ...
  {
    id: 'aprimorar-atributo',
    name: 'Aprimorar Atributo',
    level: 2,
    school: 'Transmutação',
    classes: ['bardo', 'clerigo', 'druida', 'feiticeiro', 'patrulheiro', 'mago'],
    castingTime: 'Ação',
    range: 'Toque',
  ...
  },
  {
    ...
    level: 2,
    school: 'Transmutação',
    classes: ['feiticeiro', 'patrulheiro', 'mago', 'paladino'],
    castingTime: 'Ação Bônus',
    range: 'Toque',
    components: 'V, S',
    duration: '1 hora',
  ...
  },
  {
    ...
    desc: [
      ...
      'Prosperidade Bons Infortúnio Maus Prosperidade e Infortúnio Bons e ruins Nada Nem bons, nem ruins',
      'A magia não leva em conta circunstâncias, como outras magias, que podem alterar os resultados. Se você conjurar a magia mais de uma vez antes de terminar um Descanso Longo, há uma chance cumulativa de 25% para cada conjuração após a primeira de que você não receba resposta.',
    ],
  },
  {
    id: 'aumentar-reduzir',
  ...
  },
  {
    ...
    desc: [
      ...
      'uma penalidade de −10 nos testes de Sabedoria (Percepção) e Percepção Passiva até que a magia termine.',
    ],
  },
  {
    id: 'cegueira-surdez',
  ...
  },
  {
    ...
    desc: [
      ...
      'Ações Bônus',
      'Derrubar Brilho (Apenas Ínfero; Recarrega após um Descanso Longo). Salvaguarda de Sabedoria: CD é igual a CD para evitar sua magia, uma criatura a até 18 metros à vista da montaria.',
  ...
  },
  {
    ...
    duration: 'Instantânea',
    desc: [
      'Você sente qualquer armadilha à sua vista e no alcance da magia. Uma armadilha, para o propósito desta magia, inclui qualquer objeto ou mecanismo que tenha sido criado para causar dano ou outro perigo. Assim, a magia sentiria a magia Alarme ou Glifo de Proteção',
      'ou uma armadilha mecânica, mas não revelaria uma fraqueza natural no chão, um teto instável ou um sumidouro escondido.',
  ...
  },
  {
    ...
    level: 2,
    school: 'Adivinhação',
    classes: ['bardo', 'clerigo', 'druida', 'patrulheiro', 'mago', 'paladino'],
    castingTime: 'Ação',
    range: 'Pessoal',
  ...
  },
  {
    ...
    level: 3,
    school: 'Transmutação',
    classes: ['druida', 'patrulheiro', 'paladino'],
    castingTime: 'Ação',
    range: 'Toque',
    components: 'V, S',
    duration: 'Concentração, até 1 hora',
  ...
  },
  {
    ...
    school: 'Abjuração',
    classes: ['bruxo', 'feiticeiro', 'mago'],
    castingTime: 'Reação, que você executa quando vê uma criatura a até 18 metros de você conjurando uma magia com componentes Verbais, Somáticos ou Materiais',
    range: '18 metros',
    components: 'S',
    duration: 'Instantânea',
    desc: [
  ...
  },
  {
    ...
    desc: [
      ...
      'Dano: 1d10 + 3 mais o círculo da magia em pontos de dano Cortante, e o alvo não pode recuperar Pontos de Vida até o início do próximo turno do espírito.',
      'Pancada Psíquica (Apenas Devorador de Mentes). Jogada de Ataque Corpo a Corpo: Bônus é igual ao seu modificador de ataque mágico, alcance 1,5 m. Dano: 1d8 + 3 mais o círculo da magia em pontos de dano Psíquico.',
      'Raio Ocular (Somente Pseudo-observador). Jogada de Ataque à Distância: Bônus é igual ao seu modificador de ataque mágico, alcance 45 m. Dano: 1d8 + 3 mais o círculo da magia em pontos de dano Psíquico.',
  ...
  },
  {
    ...
    desc: [
      ...
      'CD é igual a CD para evitar sua magia, qualquer criatura (exceto você) que inicie o turno dentro de uma Emanação de 1,5 metro originada a partir do espírito. Falha: A criatura tem a condição Envenenado até o início de seu próximo turno.',
      'Passagem Incorpórea (Apenas Fantasmagórico). O espírito pode se mover através de outras criaturas e objetos como se fossem Terreno Difícil. Se ele terminar o turno dentro de',
      ...
      'Bônus é igual ao seu modificador de ataque mágico, alcance 1,5 m. Dano: 1d6 + 3 mais o círculo da magia em pontos de dano Cortante. Se o alvo tem a condição Envenenado, ele tem a condição Paralisado até o final do próximo turno dele.',
      'Raio da Cova (Somente Esquelético). Jogada de Ataque à Distância: Bônus é igual ao seu modificador de ataque mágico, alcance 45 m. Dano: 2d4 + 3 mais o círculo da magia em pontos de dano Necrótico.',
      'Toque Mortal (Apenas Fantasmagórico). Jogada de Ataque Corpo a Corpo: Bônus é igual ao seu modificador de ataque mágico, alcance 1,5 m. Dano: 1d8 + 3 mais o círculo da magia em pontos de dano Necrótico, e o alvo tem a condição Amedrontado até o final do próximo turno dele.',
      'Espírito Morto-Vivo',
  ...
  },
  {
    ...
    level: 3,
    school: 'Evocação',
    classes: ['clerigo', 'druida', 'feiticeiro', 'patrulheiro', 'paladino'],
    castingTime: 'Ação',
    range: '18 metros',
    components: 'V, S',
    duration: '1 hora',
  ...
  },
  {
    ...
    duration: '1 minuto',
    desc: [
      'Jogue 1d6 no final de cada um dos seus turnos pela',
      'duração da magia. Em um resultado de 4−6, você',
  ...
  },
  {
    ...
    level: 3,
    school: 'Abjuração',
    classes: ['clerigo', 'druida', 'feiticeiro', 'patrulheiro', 'mago'],
    castingTime: 'Ação',
    range: 'Toque',
    components: 'V, S',
    duration: 'Concentração, até 1 hora',
  ...
  },
  {
    ...
    level: 4,
    school: 'Abjuração',
    classes: ['bruxo', 'clerigo', 'feiticeiro', 'mago', 'paladino'],
    castingTime: 'Ação',
    range: '9 metros',
  ...
  },
  {
    ...
    level: 4,
    school: 'Encantamento',
    classes: ['druida', 'feiticeiro', 'patrulheiro'],
    castingTime: 'Ação',
    range: '18 metros',
    components: 'V, S',
    duration: 'Concentração, até 1 minuto',
  ...
  },
  {
    ...
    desc: [
      ...
      'Dano: 1d6 + 3 mais o círculo da magia em pontos de dano Perfurante mais 1d4 pontos de dano Venenoso.',
  ...
  },
  {
    ...
    desc: [
      ...
      'Letargia Empedernida (Apenas Pedra). Quando uma criatura começa o turno dela a até 3 metros do espírito, o espírito pode atacá-la com energia mágica se o espírito puder vêla. Salvaguarda de Sabedoria: CD é igual a CD para evitar sua magia. Falha: Até o início do próximo turno do espírito, o alvo não pode realizar Ataques de Oportunidade e seu Deslocamento é reduzido pela metade.',
      'Ações',
      'Ataques Múltiplos. O espírito realiza um número de ataques de Pancada igual à metade do círculo da magia (arredondado para baixo).',
  ...
  },
  {
    ...
    desc: [
      ...
      'Ataque de Sopro. Salvaguarda de Destreza: CD é igual a CD para evitar sua magia, cada criatura em um Cone de 9 metros.',
      'Falha: 2d6 pontos de dano de um tipo ao qual o espírito tem Resistência (à sua escolha quando você conjura a magia).',
  ...
  },
  {
    ...
    duration: '24 horas',
    desc: [
      'Você torna uma área no alcance da magia magicamente segura. A área é um Cubo que pode ter de 1,5 metro a 30 metros de lado. A magia permanece pela duração. Ao conjurar a magia, você determina o tipo de proteção que a magia oferece, escolhendo qualquer uma das seguintes propriedades: • O som não pode atravessar a barreira na borda da área protegida. • A barreira da área protegida aparece escura e enevoada, impedindo a visão (incluindo Visão no Escuro) através dela. • Sensores criados por magias de Adivinhação não podem aparecer dentro da área protegida nem atravessar a barreira em seu perímetro. • Criaturas na área não podem ser alvo de magias de Adivinhação. • Nada pode se teleportar para dentro ou fora da área protegida. • Viagens planares são bloqueadas dentro da área protegida. Conjurar essa magia no mesmo local todos os dias por 365 dias faz com que a magia dure até ser dissipada.',
  ...
  },
  {
    ...
    level: 5,
    school: 'Abjuração',
    classes: ['bardo', 'bruxo', 'clerigo', 'druida', 'mago'],
    castingTime: '1 hora',
    range: '18 metros',
  ...
  },
  {
    ...
    desc: [
      ...
      'Energético igual a 1d4 + 3 (Médio ou menor), 2d6 + 3 + seu modificador de atributo de conjuração (Grande) ou 2d12 + 3 + seu modificador de atributo de conjuração (Enorme).',
    ],
  },
  {
    id: 'circulo-de-poder',
  ...
  },
  {
    ...
    desc: [
      ...
      'Materiais',
      'Materiais Duração',
      'Matéria vegetal 24 horas Rocha ou cristal 12 horas Metais preciosos 1 hora Pedras preciosas 10 minutos Adamantina ou mitral 1 minuto',
  ...
  },
  {
    ...
    desc: [
      ...
      'Punho Cerrado. A mão atinge um alvo a até 1,5 metro dela. Realize um ataque mágico corpo a corpo.',
  ...
  },
  {
    ...
    desc: [
      ...
      'Uma memória modificada não afeta necessariamente o comportamento de uma criatura, especialmente se a memória contradiz as inclinações naturais, o alinhamento ou as crenças da criatura. Uma memória modificada ilógica, como uma falsa memória de quanto a criatura gostava de nadar em ácido, é descartada como um pesadelo. O Mestre pode considerar uma memória modificada absurda demais para afetar uma criatura. Uma magia Remover Maldição ou Restauração Maior',
      'conjurada sobre o alvo restaura a memória verdadeira da criatura.',
  ...
  },
  {
    ...
    desc: [
      ...
      'Dissipar Magia. Entretanto, a magia Desintegrar a destrói instantaneamente. A muralha também se estende para o Plano Etéreo, e bloqueia viagens etéreas através dela.',
    ],
  },
  {
    id: 'muralha-de-pedra',
  ...
  },
  {
    ...
    desc: [
      ...
      '1 Aasimar 6 Golias 2 Draconato 7 Pequenino 3 Anão 8 Humano 4 Elfo 9 Orc 5 Gnomo 10 Tiferino',
  ...
  },
  {
    ...
    duration: 'Instantânea',
    desc: [
      'Você toca uma criatura e magicamente remove um dos seguintes efeitos: • 1 nível de Exaustão • A condição Enfeitiçado ou Petrificado • Uma maldição, incluindo a Sintonização do alvo com um item mágico amaldiçoado • Qualquer redução em um dos valores de atributo do alvo • Qualquer redução nos Pontos de Vida máximos do alvo',
    ],
  },
  {
    ...
    desc: [
      ...
      'completar um Descanso Longo, a penalidade é reduzida em 1 até se tornar 0.',
    ],
  },
  {
    id: 'similaridade',
  ...
  },
  {
    ...
    desc: [
      ...
      'De segunda mão (ouviu falar do alvo) +5 De primeira mão (conhece o alvo) +0 Amplo (conhece bem o alvo) –5',
      'Você Possui Algo do Alvo… Modificador',
      'Retrato ou outra imagem –2 Roupa ou outra posse –4 Parte do corpo, mecha de cabelo ou pedaço de unha –10',
  ...
  },
  {
    ...
    duration: 'Instantânea',
    desc: [
      'Você pode conjurar esta magia apenas à noite. Escolha até três cadáveres de Humanoides Médios ou Pequenos no alcance da magia. Cada um se torna um Carniçal sob seu controle (veja também o Livro dos Monstros',
      'para o bloco de estatísticas). Como uma Ação Bônus em cada um dos seus turnos, você pode comandar mentalmente qualquer criatura que tenha animado com essa magia se a criatura estiver a até 36 metros de você (se você controlar várias criaturas, pode comandar qualquer uma delas ao mesmo tempo, emitindo o mesmo comando para elas). Você decide qual ação a criatura executa e para onde ela se move no próximo turno dela, ou pode emitir um comando geral, como proteger um determinado lugar. Se você não der nenhum comando, a criatura executa a ação Esquivar e move-se apenas para evitar dano. Uma vez dada uma ordem, a criatura continua a seguir a ordem até que a tarefa seja concluída. A criatura fica sob seu controle por 24 horas, após as quais ela deixa de obedecer a qualquer comando que você tenha dado a ela. Para manter o controle da criatura por mais 24 horas, é necessário conjurar esta magia na criatura antes que o período atual de 24 horas termine. Esse uso da magia reafirma seu controle sobre até três criaturas que você animou com essa magia em vez de animar novas.',
      'Usando um Espaço de Magia de Círculo Superior. Se você usar um espaço de magia de 7º círculo, você pode animar ou reafirmar o controle sobre quatro Carniçais. Se você usar um espaço de magia de 8º círculo, você pode animar ou reafirmar o controle sobre dois',
      'Carneçais ou Inumanos ou cinco Carniçais. Se você usar um espaço de magia de 9º círculo, poderá animar ou reafirmar o controle sobre seis Carniçais, três Carneçais ou Inumanos, ou duas Múmias. Veja também o',
      'Livro dos Monstros para esses blocos de estatísticas.',
    ],
  },
  {
    id: 'cura-completa',
  ...
  },
  {
    ...
    desc: [
      ...
      'Ações',
      'Ataques Múltiplos. O espírito realiza um número de ataques igual à metade do círculo da magia (arredondado para baixo).',
      'Arremesso de Chamas (Apenas Diabo). Jogada de Ataque à Distância: Bônus é igual ao seu modificador de ataque mágico, alcance 1,5 m ou alcance 45 m. Dano: 2d6 + 3 mais o círculo da magia em pontos de dano pontos de dano Ígneo.',
      'Garras (Apenas Yugoloth). Jogada de Ataque Corpo a Corpo:',
      'Bônus é igual ao seu modificador de ataque mágico, alcance 1,5 m. Dano: 1d8 + 3 mais o círculo da magia em pontos de dano Cortante. Imediatamente após o ataque acertar ou errar, o espírito pode se teleportar até 9 metros para um espaço desocupado à vista dele.',
      'Mordida (Apenas Demônio). Jogada de Ataque Corpo a Corpo:',
      'Bônus é igual ao seu modificador de ataque mágico, alcance 1,5 m. Dano: 1d12 + 3 mais o círculo da magia em pontos de dano Necrótico.',
      'Espírito Bestial',
      'Fera Pequena, Neutra',
      'CA 11 + o círculo da magia',
      ...
      'Dilacerar. Jogada de Ataque Corpo a Corpo: Bônus é igual ao seu modificador de ataque mágico, alcance 1,5 m. Dano: 1d8 + 4 mais o círculo da magia em pontos de dano Perfurante.',
      'Usando um Espaço de Magia de Círculo Superior. Use o círculo do espaço de magia para o círculo da magia no bloco de estatísticas.',
    ],
  },
  {
  ...
  },
  {
    ...
    school: 'Abjuração',
    classes: ['clerigo'],
    castingTime: '10 minutos ou Ritual',
    range: 'Toque',
  ...
  },
  {
    ...
    desc: [
      ...
      'Proteger Fortaleza • Boca Encantada em dois locais',
  ...
  },
  {
    ...
    desc: [
      ...
      '0–20 O alvo morre. 21–30 O alvo está com as condições Atordoado, Cego e Surdo por 1 hora. 31–40 O alvo está com as condições Cego e Surdo por 10 minutos. 41–50 O alvo tem a condição Surdo por 1 minuto.',
    ],
  },
  {
    id: 'projetar-imagem',
  ...
  },
  {
    ...
    desc: [
      ...
      'ANDREW MAR A criatura retorna à vida com todos os seus Pontos de Vida, e a magia neutraliza quaisquer venenos que a afetavam na hora da morte, fecha feridas letais e restaura partes do corpo ausentes. Voltar à vida é um processo difícil. O alvo sofre uma',
      'penalidade de −4 em Testes de D20. Sempre que o alvo',
      'completar um Descanso Longo, a penalidade é reduzida em 1 até se tornar 0. Conjurar essa magia para reviver uma criatura morta há 365 dias ou mais sobrecarrega você. Até completar um Descanso Longo, você não pode conjurar magias novamente e tem Desvantagem nos Testes de D20.',
    ],
  },
  {
    id: 'simbolo',
  ...
  },
  {
    ...
    concentration: true,
    desc: [
      'Uma aura de antimagia envolve você em uma Emanação de 3 metros. Ninguém pode conjurar magias, executar a ação Usar Magia ou criar outros efeitos mágicos dentro da aura, e esses efeitos não podem ter como alvo ou afetar qualquer coisa dentro dela. As propriedades mágicas dos itens mágicos não funcionam dentro da aura ou em qualquer coisa dentro dela. Áreas de efeito criadas por magias ou outros efeitos mágicos não podem se estender para dentro da aura, e ninguém pode se teleportar para dentro ou para fora dela ou usar viagens planares para lá. Os portais se fecham temporariamente enquanto estão na aura. Magias em andamento, exceto aquelas conjuradas por um Artefato ou por uma divindade, são suprimidas na área. Enquanto um efeito é suprimido, ele não funciona, mas o tempo que ele gasta suprimido conta para sua duração',
  ...
  },
  {
    ...
    desc: [
      ...
      'Precipitação',
      'Estágio Condição',
      '1 Limpo 2 Nuvens leves 3 Nublado ou com neblina 4 Chuva, granizo ou neve 5 Chuva torrencial, tempestade de granizo ou nevasca',
      'Temperatura Vento',
      'Estágio Condição Estágio Condição',
      '1 Calor insuportável 1 Calmo 2 Quente 2 Vento moderado 3 Ameno 3 Vento forte 4 Fresco 4 Vendaval 5 Frio 5 Tempestade 6 Frio extremo',
    ],
  },
  {
    id: 'dominar-monstro',
  ...
  },
  {
    ...
    desc: [
      ...
      'Reformar a Realidade. Você pode expressar um desejo que não se encaixe nos outros efeitos. Para isso, declare seu desejo ao Mestre da maneira mais clara',
  ...
  },
  {
    ...
    desc: [
      ...
      'Campo Antimagia não tem efeito na parede, e Dissipar Magia pode afetar apenas a camada violeta.',
      'Camadas Prismáticas',
      'Ordem Efeitos',
      '1 Vermelho. Se falhar: 12d6 pontos de dano Ígneo. Em caso de sucesso: metade do dano. Efeitos Adicionais:',
      'Ataques à distância não mágicos não podem atravessar esta camada, que é destruída se sofrer ao menos 25 pontos de dano Gélido. 2 Laranja. Se falhar: 12d6 pontos de dano Ácido. Em caso de sucesso: metade do dano. Efeitos Adicionais:',
      'Ataques mágicos à distância não podem passar por esta camada, que é destruída por um vento forte (como o criado por Lufada de Vento). 3 Amarelo. Se falhar: 12d6 pontos de dano Elétrico. Em caso de sucesso: metade do dano. Efeitos Adicionais: A camada é destruída se sofrer ao menos 60 pontos de dano Energético. 4 Verde. Se falhar: 12d6 pontos de dano Venenoso. Em caso de sucesso: metade do dano. Efeitos Adicionais:',
  ...
  },
  {
    ...
    level: 9,
    school: 'Invocação',
    classes: ['bruxo', 'clerigo', 'feiticeiro', 'mago'],
    castingTime: 'Ação',
    range: '18 metros',
...
/**
 * Ids usados pelas fichas criadas antes do catálogo completo, quando o app trazia
 * traduções próprias. Mantidos para que personagens já salvos não percam magias.
 */
export const SPELL_ALIASES: Record<string, string> = {
  'ajuda': 'auxilio',
  'andar-sobre-aguas': 'caminhar-sobre-as-aguas',
  'aprimorar-habilidade': 'aprimorar-atributo',
  'armadura-de-mago': 'armadura-arcana',
  'bola-de-fogo-atrasada': 'bola-de-fogo-adiavel',
  'bordao-golpeante': 'bordao-mistico',
  'castigo-divino': 'destruicao-divina',
  'chama-produzida': 'criar-chamas',
  'chamar-relampagos': 'convocar-relampagos',
  'crescimento-de-espinhos': 'crescer-espinhos',
  'cura-em-massa': 'cura-completa-em-massa',
  'dança-irresistivel': 'danca-irresistivel-de-otto',
  'desfocar': 'turvar',
  'druidismo': 'arte-druidica',
  'escudo-de-fogo': 'escudo-ardente',
  'espada-arcana': 'espada-de-mordenkainen',
  'espiritos-guardioes': 'guardioes-espirituais',
  'festim-dos-herois': 'banquete-de-herois',
  'globos-de-luz': 'luzes-dancantes',
  'golpe-flamejante': 'coluna-de-chamas',
  'guardiao-da-fe': 'defensor-da-fe',
  'imagem-espelhada': 'reflexos',
  'imobilizar-pessoa': 'paralisar-pessoa',
  'levitar': 'levitacao',
  'liberdade-de-movimento': 'movimentacao-livre',
  'luar': 'raio-lunar',
  'maldicao-hex': 'danacao',
  'mao-magica': 'maos-magicas',
  'marca-do-cacador': 'marca-do-predador',
  'marca-flamejante': 'destruicao-radiante',
  'mente-em-branco': 'limpar-a-mente',
  'metal-escaldante': 'esquentar-metal',
  'metamorfose-verdadeira': 'polimorfia-total',
  'palavra-de-cura': 'palavra-curativa',
  'palavra-de-cura-em-massa': 'palavra-curativa-em-massa',
  'palavra-de-poder-curar': 'palavra-de-poder-salvar',
  'passar-sem-rastro': 'passo-sem-rastro',
  'passos-longos': 'passos-largos',
  'poupar-os-mortos': 'acudir-os-moribundos',
  'praga': 'malogro',
  'prestidigitacao-magica': 'prestidigitacao-arcana',
  'proteção-contra-laminas': 'protecao-contra-laminas',
  'proteção-contra-o-bem-e-o-mal': 'protecao-contra-o-bem-e-o-mal',
  'raio-guiador': 'raio-guia',
  'rajada-de-fogo': 'raio-de-fogo',
  'rajada-de-vento': 'lufada-de-vento',
  'rajada-mistica': 'raio-mistico',
  'recuo-acelerado': 'retirada-acelerada',
  'relampago-em-cadeia': 'corrente-de-relampagos',
  'remendar': 'reparar',
  'reparar-2': 'reparar',
  'salpico-acido': 'bolha-acida',
  'sopro-de-vida': 'vitalidade-vazia',
  'telecinesia': 'telecinese',
  'tempestade-de-gelo': 'tempestade-glacial',
  'toque-gelido': 'toque-necrotico',
  'velocidade': 'celeridade',
  'viagem-arborea': 'passo-arboreo',
  'zombaria-viciosa': 'zombaria-perversa',
}

export const spellById = (id: string) =>
  SPELLS.find((s) => s.id === id) ?? SPELLS.find((s) => s.id === SPELL_ALIASES[id])
